# -*- coding: utf-8 -*-
# Generated by Django 1.11.4 on 2017-08-26 08:40
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('update_dt', models.DateTimeField(blank=True, null=True, verbose_name='\u66f4\u65b0\u65f6\u95f4')),
                ('note', models.TextField(verbose_name='\u5907\u6ce8')),
                ('res_ctl_conf', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='jobtask.Res_Control_Conf', verbose_name='\u4e3b\u673a\u8d44\u6e90\u63a7\u5236')),
            ],
        ),
        migrations.AddField(
            model_name='job_task',
