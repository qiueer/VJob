...
class DetailView(generic.View):
    ...
    def get(self, request, *args, **kwargs):
        ...
        jid = kwargs.get("jobid", None)
        job_order_id = kwargs.get("job_order_id", None)
        tpl_name = "jobtask/jobtask/detail.html"
        context = locals()
        context["oid"] = oid
        context["jobid"] = jid
        context["job_order_id"] = job_order_id
        context["title"] = u"作业子任务详情"
    ...
    def post(self, request, *args, **kwargs):
        try:
            ...
            jid = kwargs.get("jobid", None)
            job_order_id = kwargs.get("job_order_id", None)
            tpl_name = "jobtask/jobtask/ajax_detail.html"
            context = locals()
            obj = get_object_or_404(models.Job_Task, id=oid)
            print obj,oid,jid
            context["object"] = obj
            t = loader.get_template(tpl_name)
            data = {"html": t.render(context), "msg": "ok" if obj.job_task_status==1 else "nook"}
...
class ListView(generic.ListView):
    model = models.Job_Task
    template_name = 'jobtask/jobtask/list.html'  
